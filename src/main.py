...
def main():
    ...
    try:
        ...
        # if config['model']['load_model'] == 'None':           # uncomment if only evaluating (no training)
        #     print("_______________    TRAINING    ___________________")
        #     model_handler.train(trainloader, validate_data)
        model_handler.test(test_data)

        print("_______________    TEST PASSED    ___________________")
        print("_______________    TEST PASSED    ___________________")


    except Exception as e:  # catch the error message to log it to mlflow

        print("_______________    error message    ___________________")
        print("_______________    error message    ___________________")
        print("_______________    error message    ___________________")
